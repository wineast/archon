...
interface ObjectTypeCreateDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onCreate: (key: string, name: string) => Promise<void>;
}

export function ObjectTypeCreateDialog({
  open,
  onOpenChange,
  onCreate,
}: ObjectTypeCreateDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Define a domain entity type for your ontology.
          </DialogDescription>
        </DialogHeader>
