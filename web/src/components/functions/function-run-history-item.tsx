...
import type { FunctionTestRunRow } from "@/db/schema";
import type { FunctionTestRunDetail } from "@/lib/functions/test-case-hooks";
import { FunctionRunResultCard } from "./function-run-result-card";

interface FunctionRunHistoryItemProps {
  run: FunctionTestRunRow;
  expanded: boolean;
  detail?: FunctionTestRunDetail;
...
export function FunctionRunHistoryItem({
  run,
  expanded,
  detail,
  loadingDetail,
