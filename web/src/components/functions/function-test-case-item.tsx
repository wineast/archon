...
import type { RunTestCaseResult } from "@/lib/functions/test-case-hooks";

export interface FunctionTestCaseItemProps {
  testCase: FunctionTestCaseRow;
  onSave: (
    caseId: string,
    data: {
      name: string;
...
export function FunctionTestCaseItem({
  testCase,
  onSave,
  onDelete,
  onRun,
