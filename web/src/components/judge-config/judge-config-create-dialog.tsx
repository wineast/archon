...
interface JudgeConfigCreateDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onCreate: (key: string, name: string) => Promise<void>;
}

export function JudgeConfigCreateDialog({
  open,
  onOpenChange,
  onCreate,
}: JudgeConfigCreateDialogProps) {
