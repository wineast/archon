...
interface LookupTableCreateDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onCreate: (key: string, name: string) => Promise<void>;
}

export function LookupTableCreateDialog({
  open,
  onOpenChange,
  onCreate,
}: LookupTableCreateDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new lookup table for enumeration data.
          </DialogDescription>
        </DialogHeader>
