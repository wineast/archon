...
export function DataObjectCreateDialog({
  open,
  onOpenChange,
  onCreate,
}: DataObjectCreateDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>New Data Object</DialogTitle>
          <DialogDescription>
            Create a new data object for structured JSON data.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. product_routes"
              autoFocus
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Product Routes"
            />
          </div>
        </div>
