...
export async function createToolTestCase(
  ...
  try {
    ...
    console.warn("createToolTestCase failed:", e);
...
export async function updateToolTestCase(
  ...
  try {
    ...
    console.warn("updateToolTestCase failed:", e);
...
export async function deleteToolTestCase(
  ...
  try {
    ...
    console.warn("deleteToolTestCase failed:", e);
...
export async function fetchToolTestRunDetail(
  ...
  try {
    ...
    console.warn("fetchToolTestRunDetail failed:", e);
...
export async function deleteToolTestRun(
  ...
  try {
    ...
    console.warn("deleteToolTestRun failed:", e);
